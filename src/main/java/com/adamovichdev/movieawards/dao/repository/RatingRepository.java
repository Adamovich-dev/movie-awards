...
public interface RatingRepository extends JpaRepository<RatingEntity, RatingId> {
    ...
    @Query(nativeQuery = true, value = "select (grade) from USER_MOVIE_RATING where user_id = :userId AND movie_award_id = :titleId")
    Integer getGradeByUserIdAndTitleId(@Param("userId") Integer userId,
