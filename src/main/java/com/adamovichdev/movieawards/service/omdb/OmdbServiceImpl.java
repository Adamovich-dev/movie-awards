...
public class OmdbServiceImpl implements OmdbService {
    ...
    @Override
    public List<MovieAwardInfoForUpdateDto> getOmdbDataForUpdateMovieAward(Map<Long, String> movieAwardsIdNomineeMap) {
        ...
        if (isNotEmpty(movieAwardsIdNomineeMap)) {
            movieAwardsIdNomineeMap.entrySet()
                    .parallelStream()
                    .forEach(entry -> {
